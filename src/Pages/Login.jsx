...
function Login() {
        ...
        try {
            ...
            if (userData) {
                ...
                if (sellerData.total > 0) {
                 ...
                 sellerAccountService.getAddressData(userData?.$id)
                 .then((res)=>{
                    if(res.total>0){
    ...
    return (
        <>
            <div className="w-full md:mb-4 font-notoSans">
                <div className="w-[97%] mx-auto mt-4 md:mt-0 md:w-[80%] lg:w-[60%]">
                    <div>
                        <div className="mb-5">
                    ...
                    <div className="ml-[2%] mb-10">
                        ...
                        <div className="login-by-password-header text-[#2e3346] text-[5.6vw] md:text-[3vw] lg:text-[2vw] font-bold leading-[7.067vw]">Welcome to Daraz</div>
                    </div>
                    <div className="flex flex-col justify-center items-center flex-1">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5 w-[98%] md:w-[80%] lg:w-[60%]">
                            ...
                            <button type="submit" disabled={isSubmitting} className="text-white bg-[#F85606] disabled:cursor-not-allowed disabled:bg-gray-700 w-full rounded-md py-3 font-semibold mx-auto">LOGIN</button>
                        </form>
                        <p className="text-sm opacity-60 mt-5 font-notoSans mb-2">Haven't signed up yet?</p>
                        <span onClick={() => navigate('/account/loginSignup/signup')} className="text-[#1E71FF] font-semibold text-sm">Sign up now</span>
                    </div>
                </div>
            </div>
        </>
