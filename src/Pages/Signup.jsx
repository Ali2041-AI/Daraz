...
function Signup() {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            await authService.signupUser({ email: data.email, pass: data.password, name: data.name });
    ...
    return (
        <>
            <div className="w-full mb-4 font-notoSans">
                <div className="w-[97%] mx-auto mt-4 md:w-[80%] lg:w-[60%]">
                    ...
                    <div className="flex flex-col justify-center items-center flex-1">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5 w-[98%] md:w-[80%] lg:w-[60%]">
                            ...
                            })} className="border mx-auto border-gray-400 px-2 py-2 outline-[#1641B5] rounded-md w-full" />
                            {errors.name && (
                            ...
                            <button type="submit" disabled={isSubmitting} className="text-white bg-[#F85606] disabled:cursor-not-allowed disabled:bg-gray-700 w-full rounded-md py-3 font-semibold mx-auto">SIGN UP</button>
                        </form>
                    </div>
                </div>
            </div>
