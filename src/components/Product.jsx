        ...
        <>
               ...
               <div  className="flex gap-4 rounded-md p-4 mt-2 bg-white" >
                    ...
                    <div className="flex flex-col gap-2 w-full" >
                        ...
                        <button onClick={()=>navigate(`/review/${product?.$id}/${product?.orderID}`)} className={`text-center border  ${product?.orderStatus!=="shipped"?"hidden":""} border-[#F85606] text-[#F85606] w-[50%] ml-auto text-sm  md:max-w-[300px] cursor-pointer rounded-lg py-1`} >WRTIE A REVIEW</button>
