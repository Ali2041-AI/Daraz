...
function AddressForm(){
    ...
    const onSubmit=async (data)=>{
       ...
       try {
           ...
           if(userAddress){
            ...
            if(data.setDefault){
             ...
             const newAddress = address.map((item) => ({
              ...
              const newAddressToAdd={country:data.Country,province:data.province,city:data.city,phoneNumber:data.phoneNumber,
                completeAddress:data.completeAddress,default:data.setDefault
            };
          ...
          //Then we need to update the array and set this new one as defaulat
                ...
                const address=[JSON.stringify({country:data.Country,province:data.province,city:data.city,phoneNumber:data.phoneNumber,
                    completeAddress:data.completeAddress,default:data.setDefault
                })]
            ...
            <div className="w-full font-notoSans">
                <div className="w-[97%] mx-auto mt-4">
                    ...
                    <div className="ml-[2%] mb-10">
                         ...
                         <div className="login-by-password-header  text-[#2e3346] mx-auto  text-[5.6vw]  font-bold leading-[7.067vw]">Enter Your Complete Address</div>
                    </div>
